...
class Settings(BaseSettings):
    ...
    runtime_artifact_job_recovery_enable: bool = Field(default=True)
    runtime_artifact_job_recovery_interval_seconds: int = Field(default=60, ge=10, le=3600)
    runtime_artifact_job_stale_seconds: int = Field(default=900, ge=60, le=86400)
    ...
    runtime_api_timeout_seconds: int = Field(default=5, ge=1, le=60)
    runtime_command_timeout_seconds: int = Field(default=30, ge=1, le=300)
    runtime_ping_timeout_seconds: int = Field(default=1, ge=1, le=30)
    ...
    runtime_swim_enable: bool = Field(default=True)
    runtime_swim_port: int = Field(default=7946, ge=1, le=65535)
    runtime_swim_probe_timeout_ms: int = Field(default=500, ge=50, le=10000)
    runtime_swim_indirect_probe_count: int = Field(default=3, ge=0, le=10)
    runtime_swim_suspect_threshold: int = Field(default=2, ge=1, le=20)
    runtime_swim_dead_threshold: int = Field(default=4, ge=2, le=50)
    runtime_swim_cooldown_seconds: int = Field(default=30, ge=1, le=3600)
